//!
//! note: @anarizzza
//! (code from kinode core app_store) with a slight modification for muzzi, first chunk is sent as 10kb, next ones 50kb
//!
use blake3::Hasher;
...
fn init(our: Address) {
        ...
        .expect("ft_worker: got unparseable init message")
    {
        DownloadRequests::LocalPlay(local_request) => {
            ...
            match handle_receiver(&parent_process, &song, &download_from) {
